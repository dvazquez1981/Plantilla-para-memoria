...
En la figura~\ref{fig:log_respuesta_backend1} se visualiza la ejecución del flujo de respuesta desde el nodo. En la consola se observa el log del ESP32-C3, el cual envía la respuesta con el resultado del proceso interno del contador. El firmware publica esta información en el tópico \texttt{dispositivo/1/respuesta}, con los campos fecha, cmdId, valor y dispositivoId.
