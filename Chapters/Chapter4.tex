...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\linewidth]{./Figures/banco2.jpg}
  \caption{Fotografía banco de pruebas.}
...
donde se presenta el listado de dispositivos registrados junto con su estado de conexión y otras variables relevantes.
...
La figura \ref{fig:frontend_dispositivo_detalle1} ilustra la primera vista del panel, donde se muestran los datos generales de identificación, el ultimo comando enviado, su respuesta y la  ultima medición.

\begin{figure}[H]
  \centering
  \includegraphics[width=1\linewidth]{./Figures/frontend_dispositivo_detalles_1.png}
  \caption{Panel de visualización del dispositivo: datos generales.}
  \label{fig:frontend_dispositivo_detalle1}
\end{figure}

La figura \ref{fig:frontend_dispositivo_detalle2} se muestra la preparación para la  ejecución de un comando.

\begin{figure}[H]
  \centering
  \includegraphics[width=1\linewidth]{./Figures/frontend_dispositivo_detalles_2.png}
  \caption{Panel de visualización del dispositivo: preparación para la ejecución de un comando.}
  \label{fig:frontend_dispositivo_detalle2}
\end{figure}

En la figura \ref{fig:frontend_dispositivo_detalle3} se habilita para la ejecución del comando.
...
La figura \ref{fig:frontend_dispositivo_detalle4} muestra el comando ejecutado y la respuesta pendiente.
...
La figura \ref{fig:frontend_dispositivo_detalle5} se muestra la respuesta al comando.

\begin{figure}[H]
  \centering
  \includegraphics[width=1\linewidth]{./Figures/frontend_dispositivo_detalles_5.png}
  \caption{Panel de visualización del dispositivo: comando ejecutado y sy respuesta.}
  \label{fig:frontend_dispositivo_detalle5}
\end{figure}


Después, en la figura \ref{fig:frontend_mediciones_detalle} se presenta el historial de mediciones, con paginación y  exportación a csv.

\begin{figure}[H]
  \centering
  \includegraphics[width=1\linewidth]{./Figures/frontend_mediciones_detalles.png}
...
La figura \ref{fig:foto_integracion} se muestra la ejecución de las prueba de integración.

\begin{figure}[H]
  \centering
  \includegraphics[width=1\linewidth]{./Figures/integracion.png}
  \caption{Fotografía pruebas finales de integración.}
  \label{fig:foto_integracion}
\end{figure}

En el video~\ref{vid:prueba_integral} se muestra la prueba completa del 
funcionamiento del sistema, que verifica la integración de los distintos 
componentes, la comunicación entre módulos y la operación general.

\begin{video}[Prueba integral del sistema en funcionamiento.]
\url{https://youtu.be/T4vcsNNGdc8?si=QBCrA6GHNZCkLFO9}
\label{vid:prueba_integral}
\end{video}
