...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\linewidth]{./Figures/banco1.jpg}
...
Después, en la figura \ref{fig:frontend_mediciones_detalle} se presenta el historial de mediciones, con su paginación y su exportación a csv.
