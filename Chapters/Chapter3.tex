...
\begin{figure}[H]
  \raggedleft
  \includegraphics[width=1.2\linewidth]{./Figures/diagConexion.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.05\linewidth]{./Figures/fotoGabinete.jpeg}
...
\begin{figure}[H]
  ...
  \centering
  \includegraphics[width=1.0\linewidth]{./Figures/diagFlujoConexionBackend.png}
...
La lógica de negocio del backend se organiza en controladores, cada uno asociado a un recurso del sistema, lo que asegura una clara separación de responsabilidades, facilita el mantenimiento y permite la escalabilidad de la aplicación:
