...
\item Contador de tránsito: dispositivo de campo que se encarga de detectar el paso de vehículos, clasificarlos y generar eventos para su posterior transmisión. También, tiene la capacidad de recibir comandos. 
